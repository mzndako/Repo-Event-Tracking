...
const setupDatabase = () => {
    ...
    //db.run('CREATE TABLE IF NOT EXISTS autho(id INTEGER, login VARCHAR(50), avatar_url VARCHAR(500), PRIMARY KEY(id))')
    //db.run('CREATE TABLE IF NOT EXISTS events(id INTEGER, login VARCHAR(50), avatar_url VARCHAR(500), PRIMARY KEY(id))')
